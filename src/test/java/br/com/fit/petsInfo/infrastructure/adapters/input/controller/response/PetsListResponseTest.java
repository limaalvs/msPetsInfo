...
class PetsListResponseTest {
	...
	void testFlatFileReaderMetadata_Parameters() throws Exception {
		...
		Assertions.assertNotNull(new PetsListResponse());

		assertThat(PetsListResponse.class, allOf(hasValidBeanConstructor(), hasValidBeanEquals(),
