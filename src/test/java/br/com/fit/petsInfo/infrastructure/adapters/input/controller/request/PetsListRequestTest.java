...
class PetsListRequestTest {

	@InjectMocks
	PetsListRequest petsListRequest;
	...
	void testFlatFileReaderMetadata_Parameters() throws Exception {
		...
		Assertions.assertNotNull(new PetsListRequest());

		assertThat(PetsListRequest.class, allOf(hasValidBeanConstructor(), hasValidBeanEquals(),
